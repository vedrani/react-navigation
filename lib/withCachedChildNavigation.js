...
function withCachedChildNavigation(Comp) {
  ...
  return (
    (_temp2 = _class = (function(_React$PureComponent) {
        ...
        return (
          ...
          (_this._updateNavigationProps = function(navigation) {
            ...
            navigation.state.routes.forEach(function(route) {
              ...
              _this._childNavigationProps[route.key] = (0,
              _addNavigationHelpers2.default)({
    ...
    (_class.displayName = 'withCachedChildNavigation(' + displayName + ')'),
    _temp2
  );
}
