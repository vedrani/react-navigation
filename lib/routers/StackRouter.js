...
exports.default = function(routeConfigs) {
  ...
  return {
        ...
        for (var i = 0; i < childRouterNames.length; i++) {
          ...
          if (_childRouter2) {
            ...
            if (navigatedChildRoute === null) {
              ...
              //without init
              var navigatedRoute = _childRouter2.getStateForAction(action);
              return _StateUtils2.default.push(
                state,
                _extends({}, navigatedRoute, {
                  key: _getUuid(),
                  routeName: childRouterName,
                })
              );
    ...
    getActionForPathAndParams: function getActionForPathAndParams(
      ...
      try {
        for (
          var _iterator = Object.entries(paths)[Symbol.iterator](), _step;
