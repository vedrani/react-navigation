  ...
  var NavigationContainer = (function(_React$Component) {
    ...
    function NavigationContainer(props) {
      ...
      var _this = _possibleConstructorReturn(
        this,
        (
          NavigationContainer.__proto__ ||
          Object.getPrototypeOf(NavigationContainer)
        ).call(this, props)
      );
      ...
      _this.dispatch = function(inputAction) {
        var action = _NavigationActions2.default.mapDeprecatedActionAndWarn(
          inputAction
        );
        ...
        (0, _invariant2.default)(
          oldNav,
          'should be set in constructor if stateful'
        );
      ...
      _this.state = {
        nav: _this._isStateful()
          ? Component.router.getStateForAction(
    ...
    _createClass(NavigationContainer, [
          ...
          if (keys.length !== 0) {
            throw new Error(
              'This navigator has both navigation and container props, so it is ' +
                ('unclear if it should own its own state. Remove props: "' +
                  keys.join(', ') +
                  '" ') +
      ...
      },
      {
        ...
        value: function componentDidMount() {
          ...
          this.subs = _PlatformHelpers.BackHandler.addEventListener(
            'hardwareBackPress',
            function() {
      ...
      },
      {
        ...
        value: function componentWillUnmount() {
          _PlatformHelpers.Linking.removeEventListener(
            'url',
            this._handleOpenURL
          );
      ...
      },
      {
        ...
        value: function render() {
          ...
          return _react2.default.createElement(
            Component,
            _extends({}, this.props, { navigation: navigation })
          );
        },
      },
    ]);
